...
public class nine extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        img.setBackgroundResource(R.drawable.ninedigit);
        ...
        final Timer T=new Timer();
          ...
          final OnClickListener right = new OnClickListener() {
         	    public void onClick(View v) {
        			...
        			tv1.setText(" Right answer ");
         			 ...
         			 Intent z =new Intent(getApplicationContext(), ten.class);
         			 z.putExtra("get10", st);
         			 startActivity(z);
         			 finish();
         	    }
         ...
         final OnClickListener wrong3 = new OnClickListener() {
           ...
           final String st=ans.getStringExtra("get9");
           if(st.equals("0")){
         	  qus.setText("Q 9.  Which team first won the Durand Cup football tournament in 1940 and most recently, 2013 ?");
               opt1.setText("A. East Bengal Club"); opt2.setText("B. Mohun Bagan"); opt3.setText("C. Dempo Sports Club"); opt4.setText("D. Mohammedan Sporting");
         	  ...
         	  qus.setText("Q 9.  ) Which of these cricketers has the distinction of claiming a wicket on the very first ball that he bowled in ODIs ?");
               opt1.setText("A. Ravinder Jadeja"); opt2.setText("B. Ishant Sharma"); opt3.setText("C. Bhuvneshwar Kumar"); opt4.setText("D. Umesh Yadav");
         	  ...
         	  qus.setText("Q 9.  In 2013, Which film was selected as the Indian entry for the Best Foreign Language Film in the Oscars ?");
               opt1.setText("A. The Lunchbox"); opt2.setText("B. The Good Road"); opt3.setText("C. Ship of Theseus"); opt4.setText("D. Lootera");
         	  ...
         	  qus.setText("Q 9.  Shahtoosh is the name given to a kind of exquisite shawl, made from the hair of which animal?");
               opt1.setText("A. Merino"); opt2.setText("B. Angora"); opt3.setText("C. Chiru"); opt4.setText("D. Pashmina");
               opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
               opt3.setOnClickListener(right);
         
           } if(st.equals("4")){
         	  qus.setText("Q 9.  A species of which of these birds is the fastest while swimming underwater ?");
               opt1.setText("A. Puffin"); opt2.setText("B. Kiwi"); opt3.setText("C. Penguin"); opt4.setText("D. Emu");
               opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
               opt3.setOnClickListener(right);
         
           } if(st.equals("5")){
         	  qus.setText("Q 9.  Complete this Sanskrit Shloka: Guru Brahma, Gurur Vishnu, Gurur Devo…..?");
               opt1.setText("A. Swamishwara"); opt2.setText("B. Maheshwara"); opt3.setText("C. Parmeshawara"); opt4.setText("D. Gyaneshwara");
               opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt4.setOnClickListener(wrong4);
               opt2.setOnClickListener(right);
         
           } if(st.equals("6")){
         	  qus.setText("Q 9.  Ram Charan Teja, who made his Hindi film debut with ‘Zanjeer’, is the son of which actor ?");
               opt1.setText("A. Chiranjeevi"); opt2.setText("B. Mammootty"); opt3.setText("C. Arvind Swamy"); opt4.setText("D. Nagarjuna");
         	  ...
         	  qus.setText("Q 9.  To measure which of these would you use only your hand rather than any instrument ?");
               opt1.setText("A. 1 paav bhindi"); opt2.setText("B. 2 ser gehun"); opt3.setText("C. 4 ratti maanik"); opt4.setText("D. 2 bitta dhanga");
               opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt2.setOnClickListener(wrong2);
               opt4.setOnClickListener(right);
         
           } if(st.equals("8")){
         	  qus.setText("Q 9. Which of these is a kind of shot played by a batsman in cricket ?");
               opt1.setText("A. Circle Drive"); opt2.setText("B. Triangle Sweep"); opt3.setText("C. Square cut"); opt4.setText("D. Rectangle hook");
               opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
               opt3.setOnClickListener(right);
