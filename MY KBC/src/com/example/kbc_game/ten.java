...
Cursor cur;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        img.setBackgroundResource(R.drawable.tendigit);
        ...
        final Timer T=new Timer();
         	    ...
         	    public void onClick(View v) {
         	      ...
         	      //  m3.stop();
        			...
        			tv1.setText(" Right answer ");
         			 ...
         			 Intent z =new Intent(getApplicationContext(), eleven.class);
         			 z.putExtra("get11", st);
         			 startActivity(z);
         			 finish();
         	    }
         ...
         final OnClickListener wrong3 = new OnClickListener() {
           ...
           final String st=ans.getStringExtra("get10");
           if(st.equals("0")){
         	  qus.setText("Q 10.  After whom is the annual award, given by the Govt of India to an outstanding handloom weaver, named ?");
               opt1.setText("A. Acharya Vinoba Bhave"); opt2.setText("B. Sant Kabir"); opt3.setText("C. Mahatma Gandhi"); opt4.setText("D. Gul Ahmed");
         	  ...
         	  qus.setText("Q 10.  Which of these words means ‘revolution’ in Arabic?");
               opt1.setText("A. Isteqbaal"); opt2.setText("B. Intikhaab"); opt3.setText("C. Inquilab"); opt4.setText(". Intequam");
         	  ...
         	  qus.setText("Q 10.  Which animal experiences the maximum amount of daylight in a year?");
               opt1.setText("A. Atlantic Salmon"); opt2.setText("B. Grey Whale"); opt3.setText("C. Arctic Tern"); opt4.setText("D. Monarch Butterfly");
               opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt4.setOnClickListener(wrong4);
               opt2.setOnClickListener(right);
         
           } if(st.equals("3")){
         	  qus.setText("Q 10.  Which of these dishes are usually “tari ya ras waali” and “sukhi” ?");
               opt1.setText("A. Raita"); opt2.setText("B. Papdi"); opt3.setText("C. Sabji"); opt4.setText("D. Pulaav");
               opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
               opt3.setOnClickListener(right);
         
           } if(st.equals("4")){
         	  qus.setText("Q 10.  Which of these freedom fighters was the English language secretary to Mahatma Gandhi for 16 years?");
               opt1.setText("A. Hansa Mehta"); opt2.setText("B. Rajkumari Amrit Kaur"); opt3.setText("C. Sarojini Naidu"); opt4.setText("D. Sushila Nayyar");
               opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt4.setOnClickListener(wrong4);
               opt2.setOnClickListener(right);
         
           } if(st.equals("5")){
         	  qus.setText("Q 10  ) From which country did India buy an aircraft carrier which was renamed as INS Vikramaditya?");
               opt1.setText("A. France"); opt2.setText("B. Russia"); opt3.setText("C. England"); opt4.setText("D. Germany");
               opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt4.setOnClickListener(wrong4);
               opt2.setOnClickListener(right);
         
           } if(st.equals("6")){
         	  qus.setText("Q 10.  ) Which poem are these lines from : “Nari tum keval Shraddha ho, Vishwas-rajat-nag- pagtal mein, Piyush-srot-si baha karo, Jivan ke sunder samtal hein” ?");
               opt1.setText("A. Aansu"); opt2.setText("B. Prem Pathik"); opt3.setText("C. kaanan Kusum"); opt4.setText("D. Kamayani");
         	  ...
         	  qus.setText("Q 10.  Q 14. (KBC7EP35) Which animal experiences the maximum amount of daylight in a year?");
               opt1.setText("A. Atlantic Salmon"); opt2.setText("B. Grey Whale"); opt3.setText("C. Arctic Tern"); opt4.setText("D. Monarch Butterfly");
               opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
               opt3.setOnClickListener(right);
         
           } if(st.equals("8")){
         	  qus.setText("Q 10.  In Which of these regions would you find the town of Kishtwar ?");
               opt1.setText("A. Jammu"); opt2.setText("B. Vidarbha"); opt3.setText("C. Saurashtra"); opt4.setText("D. Bundelkhand");
         	  ...
         	  qus.setText("Q 10.  Which of these sportsmen has not yet won the Rajiv Gandhi Khel Ratna Award ?");
               opt1.setText("A. Anju Bobby George"); opt2.setText("B. Anjali Bhagwat"); opt3.setText("C. Krishna Poonia"); opt4.setText("D. Mary Kom");
               opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
               opt3.setOnClickListener(right);
