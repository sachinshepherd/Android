...
public class fifteen extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        img.setBackgroundResource(R.drawable.fifteenedigit);
         ...
         final OnClickListener right = new OnClickListener() {
             public void onClick(View v) {
    			...
    			tv1.setText(" Right answer ");
    			 final Intent z = new Intent(getApplicationContext(), score.class);
                  z.putExtra("scr", "7 Crore");
                  startActivity(z);
                  finish();
             }
           };
       ...
       final OnClickListener wrong3 = new OnClickListener() {
         ...
         final String st=ans.getStringExtra("get15");
         if(st.equals("0")){
       	  qus.setText("Q 15.  Which one of these , among the ten highest mountain peaks in the world, is not in the Himalayas ?");
             opt1.setText("A. Nanga Parbat"); opt2.setText("B. K2"); opt3.setText("C. Cho Oyu"); opt4.setText("D. Makalu");
       	  ...
       	  qus.setText("Q 15.  In which state would you find the areas of bastar, Durg and Korba ?");
             opt1.setText("A. Chhattisgarh"); opt2.setText("B. Madhya Pradesh"); opt3.setText("C. Jharkhand"); opt4.setText("D. Odisha");
       	  ...
       	  qus.setText("Q 15.  Who is the only tennis player to win all four Grand Slams and an Olympics Gold in the same year ? ");
             opt1.setText("A. Serena Williams"); opt2.setText("B. Pete Sampras"); opt3.setText("C. Steffi Graf"); opt4.setText("D. Roger Federer");
