...
Cursor cur;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        img.setBackgroundResource(R.drawable.twelvedigit);
        ...
        final Timer T=new Timer();
          ...
          final OnClickListener right = new OnClickListener() {
         	    public void onClick(View v) {
        			...
        			tv1.setText(" Right answer ");
         			 ...
         			 Intent z =new Intent(getApplicationContext(), thirteen.class);
         			 z.putExtra("get13", st);
         			 startActivity(z);
         			 finish();
         	    }
         ...
         final OnClickListener wrong3 = new OnClickListener() {
           ...
           final String st=ans.getStringExtra("get12");
           if(st.equals("0")){
         	  qus.setText("Q 12.  Whom did Lalu Prasad Yadav replace as the Chief Minister of Bihar in 1990?");
               opt1.setText("A. Bhagwan Jha Azad"); opt2.setText("B. Jaganth Mishra"); opt3.setText("C. Sateyndra nath Sinha"); opt4.setText("D. Bindheswar Dubey");
         	  ...
         	  qus.setText("Q 12.  The courts of which of those Grand Slam tournaments is often called as ‘Lak Bajri’ by the Hindi media?");
               opt1.setText("A. French open"); opt2.setText("B. Australian Open"); opt3.setText("C. US Open"); opt4.setText("D. Wimbledon");
         	  ...
         	  qus.setText("Q 12.  Which medicine is generally injected in the body to fight bacteria in wounds caused by cuts from rusty items?");
               opt1.setText("A. Insulin"); opt2.setText("B. Anti Rabies"); opt3.setText("C. Anti Tetanus"); opt4.setText("D. Vitamin B12");
