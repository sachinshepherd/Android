...
public class fourteen extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        img.setBackgroundResource(R.drawable.fourteendigit);
        ...
        final Timer T=new Timer();
          ...
          final OnClickListener right = new OnClickListener() {
         	    public void onClick(View v) {
        			...
        			tv1.setText(" Right answer ");
         			 ...
         			 Intent z =new Intent(getApplicationContext(), fifteen.class);
         			 z.putExtra("get15", st);
         			 startActivity(z);
         			 finish();
         	    }
         ...
         final OnClickListener wrong3 = new OnClickListener() {
           ...
           final String st=ans.getStringExtra("get14");
           if(st.equals("0")){
         	  qus.setText("Q 14.  According to Abhigyana Shakuntlam, as result of which Rishi’s curse did king Dushyant forget Shakuntla?");
               opt1.setText("A. Vishwamitra"); opt2.setText("B. Durvasa"); opt3.setText("C. Kanva"); opt4.setText("D. Kapil");
         	  ...
         	  qus.setText("Q 14. According to the Rigveda, to which god does the sun hand over his effulgence in the evening and take it back in the morning ?");
               opt1.setText("A. Indra"); opt2.setText("B. Varuna"); opt3.setText("C. Agni"); opt4.setText("D. Vayu");
         	  ...
         	  qus.setText("Q 14.  Which river, a headstream of Ganga, flows by the Badrinath Shrine ?");
               opt1.setText("A. Dhauliganga"); opt2.setText("B. Bhagirathi"); opt3.setText("C. Mandakini"); opt4.setText("D. Alakananda");
               opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt4.setOnClickListener(wrong4);
               opt2.setOnClickListener(right);
      ...
      final String st=ans.getStringExtra("get14");
		 ...
		 if(st.equals("0")){
		   ...
		   if(st.equals("3")){
			   ...
			   opt1.setEnabled(false);opt1.setBackgroundResource(R.drawable.playbuttonred);}
		   if(st.equals("4")){
			   opt4.setEnabled(false);opt3.setBackgroundResource(R.drawable.playbuttonred);
			   opt1.setEnabled(false);opt1.setBackgroundResource(R.drawable.playbuttonred);}
		   if(st.equals("5")){
			   opt3.setEnabled(false);opt3.setBackgroundResource(R.drawable.playbuttonred);
			   opt1.setEnabled(false);opt1.setBackgroundResource(R.drawable.playbuttonred);}
