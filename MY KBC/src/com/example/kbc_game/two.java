...
Cursor cur;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        img.setBackgroundResource(R.drawable.twodigit);
           ...
           final OnClickListener right = new OnClickListener() {
          	    public void onClick(View v) {
        			...
        			tv1.setText(" Right answer ");
          			 ...
          			 Intent z =new Intent(getApplicationContext(), three.class);
          			 z.putExtra("get3", st);
          			 startActivity(z);
          			 finish();
          	    }
        ...
        final OnClickListener wrong3 = new OnClickListener() {
          ...
          final String st=ans.getStringExtra("get2");
          if(st.equals("0")){
        	  qus.setText("Q 2.  Which of these is a popular game?");
              opt1.setText("A.Twitter"); opt2.setText("B.Angry Birds"); opt3.setText("C.Whatsapp"); opt4.setText("D. Instagram");
        	  ...
        	  qus.setText("Q 2.  Which of these neighboring countries of India is the smallest in terms of area ?");
              opt1.setText("A.Myanmar"); opt2.setText("B.Bhutan"); opt3.setText("C.Nepal"); opt4.setText("D.Sri Lanka");
              opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt4.setOnClickListener(wrong4);
              opt2.setOnClickListener(right);
        
          } if(st.equals("2")){
        	  qus.setText("Q 2.  Which search engine has a button that says “I’m feeling Lucky ?");
              opt1.setText("A.Bing"); opt2.setText("B.Google"); opt3.setText("C.Yahoo!"); opt4.setText("D. Wikipedia");
              opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt4.setOnClickListener(wrong4);
              opt2.setOnClickListener(right);
        
          } if(st.equals("3")){
        	  qus.setText("Q 2.  In India, on the back of which of these cards would you find a magnetic strip ?");
              opt1.setText("A.PAN Card"); opt2.setText("B.Licence Card"); opt3.setText("C.ATM Card"); opt4.setText("d.Debit Card");
        	  ...
        	  qus.setText("Q 2.  Which of these is is a kind of a mobile phone?");
              opt1.setText("A.Dashing Phone"); opt2.setText("B.Cool Phone"); opt3.setText("C.Smart Phone"); opt4.setText("D. Long Phone");
              opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
              opt3.setOnClickListener(right);
        
          } if(st.equals("5")){
        	  qus.setText("Q 2.  Which of these is true about a leap year ?");
              opt1.setText("A.Has only 28 days in February"); opt2.setText("B.Has 366 days in a year"); opt3.setText("C.All months have 30 days"); opt4.setText("D. Has only 365 days in a year");
              opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt4.setOnClickListener(wrong4);
              opt2.setOnClickListener(right);
        
          } if(st.equals("6")){
        	  qus.setText("Q 2. .  Tandoori, Khasta and Missi are all types of what ?");
              opt1.setText("A.Dal"); opt2.setText("B.Rice"); opt3.setText("C.Roti"); opt4.setText("D. Vegetables");
              opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
              opt3.setOnClickListener(right);
        
          } if(st.equals("7")){
        	  qus.setText("Q 2.  In the movie, ‘Athithi tum kab jaoge’, who played the role of a guest.");
              opt1.setText("A.Anupam Kher"); opt2.setText("B.Paresh Rawal"); opt3.setText("C.Boman Irani"); opt4.setText("D. Satish Kasushik");
              opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt4.setOnClickListener(wrong4);
              opt2.setOnClickListener(right);
        
          } if(st.equals("8")){
        	  qus.setText("Q 2.  Out of these relationships which represents the word “Babul” ?");
              opt1.setText("A.Brother"); opt2.setText("B.Husband"); opt3.setText("C.Father"); opt4.setText("D. Lover");
              opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
              opt3.setOnClickListener(right);
        
          }if(st.equals("9")){
        	  qus.setText("Q 2.  Which of these is a widely used web browser of Microsoft?");
              opt1.setText("A.Firefox"); opt2.setText("B.Chrome"); opt3.setText("C.IE"); opt4.setText("D. Safari");
              opt1.setOnClickListener(wrong1);  opt2.setOnClickListener(wrong2);opt4.setOnClickListener(wrong4);
              opt3.setOnClickListener(right);
