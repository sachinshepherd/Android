...
public class eleven extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        img.setBackgroundResource(R.drawable.elevendigit);
        ...
        final Timer T=new Timer();
          ...
          final OnClickListener right = new OnClickListener() {
         	    public void onClick(View v) {
        			...
        			tv1.setText(" Right answer ");
         			 ...
         			 Intent z =new Intent(getApplicationContext(), twelve.class);
         			 z.putExtra("get12", st);
         			 startActivity(z);
         			 finish();
         	    }
         ...
         final OnClickListener wrong3 = new OnClickListener() {
           ...
           final String st=ans.getStringExtra("get11");
           if(st.equals("0")){
         	  qus.setText("Q 11.  In which district of Chhattisgarh did Maoists attack a convoy of Congress leaders on 25 May 2013?");
               opt1.setText("A. Sukma"); opt2.setText("B. Bastar"); opt3.setText("C. Dantewada"); opt4.setText("D. Mahasamund");
         	  ...
         	  qus.setText("Q 11.  Which football club won the English Premier League in 2012 after a gap of 44 years?");
               opt1.setText("A. Queens Park Rangers"); opt2.setText("B. Newcastle United"); opt3.setText("C. Liverpool"); opt4.setText("D. Manchester City");
         	  ...
         	  qus.setText("Q 11.  Which Pakistani team played in the 2013 Champions League T20?");
               opt1.setText("A. Karachi Dolphins"); opt2.setText("B. Lahore Lions"); opt3.setText("C. Faisalabad Wolves"); opt4.setText("D. Hyderabad Hawks");
         	  ...
         	  qus.setText("Q 11.  Which of these animals is depicted in a zodiac sign?");
               opt1.setText("A. Octopus"); opt2.setText("B. Turtle"); opt3.setText("C. Spider"); opt4.setText("D. Crab");
               opt1.setOnClickListener(wrong1);  opt3.setOnClickListener(wrong3);opt2.setOnClickListener(wrong2);
               opt2.setOnClickListener(right);
